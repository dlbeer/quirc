...
Quirc.prototype['decode'] = Quirc.prototype.decode = /** @suppress {undefinedVars, duplicate} */function(code) {
  var self = this.ptr;
  if (code && typeof code === 'object') code = code.ptr;
  return wrapPointer(_emscripten_bind_Quirc_decode_1(self, code), Result);
};;
...
Quirc.prototype['getPixelRGBA'] = Quirc.prototype.getPixelRGBA = /** @suppress {undefinedVars, duplicate} */function(index) {
  var self = this.ptr;
  if (index && typeof index === 'object') index = index.ptr;
  return _emscripten_bind_Quirc_getPixelRGBA_1(self, index);
};;
...
// Result
/** @suppress {undefinedVars, duplicate} */function Result() { throw "cannot construct a Result, no constructor in IDL" }
Result.prototype = Object.create(WrapperObject.prototype);
Result.prototype.constructor = Result;
Result.prototype.__class__ = Result;
Result.__cache__ = {};
Module['Result'] = Result;

  Result.prototype['get_error'] = Result.prototype.get_error = /** @suppress {undefinedVars, duplicate} */function() {
  var self = this.ptr;
  return _emscripten_bind_Result_get_error_0(self);
};
    Result.prototype['set_error'] = Result.prototype.set_error = /** @suppress {undefinedVars, duplicate} */function(arg0) {
  var self = this.ptr;
  if (arg0 && typeof arg0 === 'object') arg0 = arg0.ptr;
  _emscripten_bind_Result_set_error_1(self, arg0);
};
    Object.defineProperty(Result.prototype, 'error', { get: Result.prototype.get_error, set: Result.prototype.set_error });
  Result.prototype['get_data'] = Result.prototype.get_data = /** @suppress {undefinedVars, duplicate} */function() {
  var self = this.ptr;
  return wrapPointer(_emscripten_bind_Result_get_data_0(self), Data);
};
    Result.prototype['set_data'] = Result.prototype.set_data = /** @suppress {undefinedVars, duplicate} */function(arg0) {
  var self = this.ptr;
  if (arg0 && typeof arg0 === 'object') arg0 = arg0.ptr;
  _emscripten_bind_Result_set_data_1(self, arg0);
};
    Object.defineProperty(Result.prototype, 'data', { get: Result.prototype.get_data, set: Result.prototype.set_data });
  Result.prototype['__destroy__'] = Result.prototype.__destroy__ = /** @suppress {undefinedVars, duplicate} */function() {
  var self = this.ptr;
  _emscripten_bind_Result___destroy___0(self);
};
// VoidPtr
